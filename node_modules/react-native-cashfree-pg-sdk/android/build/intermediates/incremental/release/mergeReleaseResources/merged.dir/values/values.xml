...
<resources xmlns:ns1="http://schemas.android.com/tools" xmlns:ns2="urn:oasis:names:tc:xliff:document:1.2">
    <string-array name="cf_upi_priority_apps">
        <item>com.google.android.apps.nbu.paisa.user</item>
        <item>com.phonepe.app</item>
        <item>net.one97.paytm</item>
        <item>com.dreamplug.androidapp</item>
        <item>in.amazon.mShop.android.shopping</item>
    </string-array>
    <integer-array name="progress_color">
        <item>@color/cf_progress_green</item>
        <item>@color/cf_progress_yellow</item>
        <item>@color/cf_progress_green</item>
        <item>@color/cf_progress_yellow</item>
    </integer-array>
    ...
    <bool name="cashfree_custom_analytics_subscriber_enabled">false</bool>
    <bool name="cashfree_pg_core_auto_initialize_enabled">true</bool>
    <bool name="cashfree_pg_core_encrypt_pref_enabled">true</bool>
    <bool name="cashfree_pg_core_reporting_enabled">true</bool>
    <bool name="cf_quick_checkout_enabled">true</bool>
    <bool name="isDeviceTablet">false</bool>
    ...
    <color name="app_screen_background">#F4F6F9</color>
    ...
    <color name="cf_black">#000000</color>
    <color name="cf_cancel_red">#CB2C2C</color>
    <color name="cf_card_border_color">#D3D5D4</color>
    <color name="cf_card_corner_stroke">#E6E9EE</color>
    <color name="cf_progress_green">#04AB61</color>
    <color name="cf_progress_yellow">#FBB016</color>
    <color name="cf_white">#FFFFFF</color>
    <color name="color_cta">#6A3FD3</color>
    ...
    <dimen name="cf_dimen_12">12dp</dimen>
    <dimen name="cf_dimen_16">16dp</dimen>
    <dimen name="cf_dimen_18">18dp</dimen>
    <dimen name="cf_dimen_2">2dp</dimen>
    <dimen name="cf_dimen_20">20dp</dimen>
    <dimen name="cf_dimen_24">24dp</dimen>
    <dimen name="cf_dimen_28">28dp</dimen>
    <dimen name="cf_dimen_32">32dp</dimen>
    <dimen name="cf_dimen_36">36dp</dimen>
    <dimen name="cf_dimen_4">4dp</dimen>
    <dimen name="cf_dimen_42">42dp</dimen>
    <dimen name="cf_dimen_44">44dp</dimen>
    <dimen name="cf_dimen_54">54dp</dimen>
    <dimen name="cf_dimen_6">6dp</dimen>
    <dimen name="cf_dimen_8">8dp</dimen>
    <dimen name="cf_margin_normal">16dp</dimen>
    <dimen name="cf_text_size_12">12sp</dimen>
    <dimen name="cf_text_size_14">14sp</dimen>
    <dimen name="cf_text_size_18">18sp</dimen>
    ...
    <integer name="cashfree_pg_logging_level">4</integer>
    ...
    <string name="bank_redirection_info">You can also complete this transaction on bank’s website.</string>
    <string name="bank_redirection_text">Redirect to Bank’s Site</string>
    ...
    <string name="cf_are_you_sure_you_want_to_exit_payment">Are you sure you want to exit payment?</string>
    <string name="cf_auto_submit_message">Smart OTP will automatically read and submit the OTP</string>
    <string name="cf_cancel_auto_submit">Cancel Auto Submit</string>
    <string name="cf_cta_no">No</string>
    <string name="cf_cta_yes">Yes</string>
    <string name="cf_enter_one_time_password">Enter One Time Password</string>
    <string name="cf_enter_otp">Enter OTP</string>
    <string name="cf_exiting_payment">Exiting Payment</string>
    <string name="cf_otp_for_text">Enter OTP for  \u20B9%s</string>
    <string name="cf_otp_message">Please enter OTP sent to your registered mobile number</string>
    <string name="cf_otp_page_timeout">This page will timeout in %s minutes.</string>
    <string name="cf_otp_resend_successfully">OTP sent successfully.</string>
    <string name="cf_pay">Pay</string>
    <string name="cf_pay_merchant">Pay %s</string>
    <string name="cf_pay_proceed">Proceed to Pay</string>
    <string name="cf_pay_rupee_amount">Pay ₹%.2f</string>
    <string name="cf_pay_usd_amount">Pay $%.2f</string>
    <string name="cf_phone_hint">Enter Phone Number</string>
    <string name="cf_qr_des">Scan the QR code using your UPI apps</string>
    <string name="cf_resent_otp">Resend OTP</string>
    <string name="cf_rupee_pay_text_toolbar">₹ %.2f</string>
    <string name="cf_save_mode">Save mode for quick checkout</string>
    <string name="cf_save_upi_id">Save UPI ID for quick checkout</string>
    <string name="cf_search_banks">Search Banks</string>
    <string name="cf_secured">Secured by</string>
    <string name="cf_select_used_payment_mode">Select from recently used payment mode</string>
    <string name="cf_show_other_payment_modes">Show Other Payment Modes</string>
    <string name="cf_title_card">Card</string>
    <string name="cf_title_emi">EMI</string>
    <string name="cf_title_emi_cost">Cost \n(Rs)</string>
    <string name="cf_title_emi_interest">Interest\n(pa)</string>
    <string name="cf_title_emi_month">Month</string>
    <string name="cf_title_emi_plan">EMI Plan</string>
    <string name="cf_title_emi_screen_title">EMI Payments</string>
    <string name="cf_title_nb">Net Banking</string>
    <string name="cf_title_pay_later">Pay Later</string>
    <string name="cf_title_upi">UPI</string>
    <string name="cf_title_wallet">Wallet</string>
    <string name="cf_upi_hint">Enter UPI ID</string>
    <string name="cf_usd_pay_text_toolbar">$ %.2f</string>
    ...
    <string name="hint_card_holder_name">Card Holder Name</string>
    <string name="hint_card_holder_number">Card Number</string>
    <string name="hint_card_mm_yy">MM/YY</string>
    ...
    <string name="no_delete_Card">No don\'t</string>
    ...
    <string name="pay_with_upi_id">Pay with UPI ID</string>
    <string name="payments_secured_by">Payments Secured by</string>
    ...
    <string name="saved_card_delete_confirmation">Are you sure you want to delete?</string>
    <string name="saved_card_securely">Save card securely for future payments</string>
    ...
    <string name="select_upi_application">Select UPI Application</string>
    ...
    <string name="submit_approve">Approve</string>
    <string name="submit_message">Submitting the OTP</string>
    <string name="submit_otp_in">Submitting OTP in</string>
    ...
    <string name="yes_delete_card">Yes, Delete</string>
    ...
    <style name="CFBottomSheetDialog" parent="@style/ThemeOverlay.MaterialComponents.BottomSheetDialog">
        <item name="android:windowIsFloating">false</item>
        <item name="android:statusBarColor" ns1:targetApi="lollipop">@android:color/transparent
        </item>
        <item name="android:windowSoftInputMode">adjustResize</item>
        <item name="colorPrimaryDark">#6A3FD3</item>
        <item name="colorPrimary">#6A3FD3</item>
        <item name="colorSecondary">#6A3FD3</item>
        <item name="colorSecondaryVariant">#6A3FD3</item>
        <item name="colorAccent">#6A3FD3</item>
        <item name="bottomSheetStyle">@style/CustomBottomSheetStyle</item>
    </style>
    <style name="CFCoreTheme" parent="Theme.MaterialComponents.Light.NoActionBar">
        <item name="android:statusBarColor" ns1:targetApi="lollipop">@color/color_cta</item>
        <item name="colorPrimary" ns1:targetApi="lollipop">@color/color_cta</item>
        <item name="colorPrimaryDark" ns1:targetApi="lollipop">@color/color_cta</item>
        <item name="bottomSheetDialogTheme">@style/CFBottomSheetDialog</item>
    </style>
    <style name="CFCoreUPIStyle" parent="Theme.MaterialComponents.Light.NoActionBar">
    ...
    <style name="CFSeamlessStyle" parent="Theme.MaterialComponents.Light.NoActionBar">
        <item name="android:statusBarColor" ns1:targetApi="lollipop">#0000</item>
        <item name="colorPrimary" ns1:targetApi="lollipop">#0000</item>
        <item name="colorPrimaryDark" ns1:targetApi="lollipop">#0000</item>
        <item name="android:windowIsTranslucent">true</item>
    ...
    <style name="CFUITheme" parent="Theme.MaterialComponents.Light.NoActionBar">
        <item name="colorPrimary" ns1:targetApi="lollipop">#6A3FD3</item>
        <item name="colorSecondary" ns1:targetApi="lollipop">#6A3FD3</item>
        <item name="materialCardViewStyle">@style/Cashfree.CardView</item>
        <item name="cardViewStyle">@style/Cashfree.CardView</item>
        <item name="bottomSheetDialogTheme">@style/CFBottomSheetDialog</item>
    </style>
    ...
    <style name="Cashfree.CardView" parent="Widget.MaterialComponents.CardView">
    ...
    <declare-styleable name="CFCardNumberView">
        <attr format="string" name="cf_card_error_text"/>
        <attr format="dimension" name="cf_card_text_size"/>
    </declare-styleable>
    ...
    <declare-styleable name="CollapsingImageBehavior">
        <attr format="reference" name="collapsedTarget"/>
    </declare-styleable>
